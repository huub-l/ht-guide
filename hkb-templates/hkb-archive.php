...
<div class="ht-container">
	...
	if ( '' != $ht_hometitle ) :
		?>
		<h2 class="hkb-archive__title">Your How-To Guide for Technology
			<span>Technology can be frustrating. That’s why we created HelloTech How. Discover useful answers and step-by-step instructions to your tech questions.</span>
		</h2>
	<?php endif; ?>
		...
		<?php if ( $tax_terms ) : ?>
			...
			<h3 class="category-label"><?php echo esc_html( $ht_hometitle ); ?></h3>
